...
const CustomSelectDropdown = ({ selected = {}, menu, placeholder = 'Select...', handleSelect, disabled = false, className }) => {
    ...
    return (
        <div  className={`${className}  custom-select`}>
            <div aria-expanded={expanded} onClick={() => setExpanded(s => !s)} className={`filled toggler-btn ${selected?'':'placeholder'} cursor-pointer`}>
